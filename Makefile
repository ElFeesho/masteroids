OBJS=gamepadinputmanager.o main.o UFO.o about.o asteroid.o bullet.o collobj.o controlconf.o debris.o engine.o entity.o gameover.o ingame.o SDLGRRLIB.o menu.o options.o ship.o ufobullet.o libwiiwrap/ogcsys.o libwiiwrap/gccore.o libwiiwrap/ogc/lwp_watchdog.o libwiiwrap/wiiuse/wpad.o sdlgfx.o keyboardsource.o
