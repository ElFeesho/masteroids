...
void DebrisFountain::projectDebris(EntityList &entityList, Direction direction, Position from, double spread, int amount)
{
	...
	{
		entityList.add(new Debris(direction, from, Shape(5.0f)));
